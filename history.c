...
/**
 * write_history – will create file, or append to an existing one
 * @info: Parameter structure
 *
...
/**
 * read_history – Will read history from the file
 * @info: Parameter structure
 *
